  ...
  return (
    <footer className="app-footer full">
      ...
      <section className="social-media">
        <a href=""><img src="/src/assets/imgs/icon-facebook.svg" alt="facebook" /></a>
        <a href=""><img src="/src/assets/imgs/icon-pinterest.svg" alt="pinterest" /></a>
        <a href=""><img src="/src/assets/imgs/icon-twitter.svg" alt="twitter" /></a>
      </section>
